    ...
    return (
        <section className='about' id='about'>
            ...
            <div className="container">
                <div className="row">
                    <div className="col-lg-6" style={{marginBottom: "30px"}} data-aos="fade-right">
                        <h1 className="top">О НАС</h1>
                        <p className="top">ИННОВАЦИОННЫЕ РЕШЕНИЯ ДЛЯ ВАШЕГО ПРОИЗВОДСТВА В ПРОЕКТИРОВАНИИ</p>
                    ...
                    <div className="col-lg-6" data-aos="fade-right">
                        <p className="right-top">
                            ...
                            газа, с его генерации в пар, электроэнергию, горячую воду , с последующей его очисткой . Мы создаем эффективные и
                        ...
                        <img src={foto} alt="Наша цель" loading={"lazy"}/>
                    </div>
                </div>
            </div>
        </section>
