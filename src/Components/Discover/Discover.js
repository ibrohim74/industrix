...
import "./discover.css"
import discover from "../../Assisstens/img/discover.png";
const Discover = () => {
    return (
                ...
                <div className="discover_box">
                    <div className="discover_left">
                        <div className="discover_left_item">
                            ...
                            <div className="discover_left_item_text">
                                <h1>ИННОВАЦИИ В ПРОЕКТИРОВАНИИ ТЕХНОЛОГИЙ</h1>
                                <p>
                    ...
                    <div className="discover_right">
                        <div className="discover_right_item">
                            <h1>ВЫБОР ТЕХНОЛОГИЧЕСКОГО РЕШЕНИЯ</h1>
                            <p>
                        ...
                        <div className="discover_right_item">
                            <h1>ИССЛЕДОВАНИЕ ДОСТУПНЫХ РЕШЕНИЙ НА РЫНКЕ</h1>
