                    ...
                    <div className="col-lg-4 headerTitle_item">
                        <div className="box" data-aos="fade-right">
                            ...
                            <p className="title">
                                ...
                                технологических линий , с использованием газоанализаторов и прибора замера уровня запыленности.
                            </p>
                    ...
                    <div className="col-lg-4 headerTitle_item">
                        <div className="box" data-aos="fade-right">
                            ...
                            <p className="title">
                                ...
                                экологичных материалов и технологий , основанных на достоверных данных замеров.
                            </p>
                            <div className="bottom">
